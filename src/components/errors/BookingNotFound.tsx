...
const BookingNotFound: React.FC<BookingNotFoundProps> = ({ error }) => {
    ...
    <Card>
      <ErrorContainer>
        ...
        <Typography $typographyType="h3" as="h3">
          {t("common:errors.booking-not-found-title")}
        </Typography>
        <InfoBox>{t("common:errors.booking-not-found-message")}</InfoBox>
        <ButtonContainer>
          {error.canRetry && (
